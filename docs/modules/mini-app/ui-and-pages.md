# Телеграм-магазин: внешний вид и основные страницы

Телеграм-магазин — это веб‑приложение внутри Telegram. Ниже — обзор ключевых экранов и элементов интерфейса.
...
- Телеграм-магазин наследует тему мессенджера (светлая/тёмная).  
